...
<body>
    ...
    <div>
      ...
      <input type="text" class="form-control" name="valor_compra"  required  id="exampleFormControlInput1" placeholder="Informe o valor de compra">
    </div>
    <div class="mb-3">
      <label for="exampleFormControlInput1" class="form-label">Valor de venda</label>
      <input type="text" class="form-control" name="valor_venda" required id="exampleFormControlInput1" placeholder="Informe o valor de venda">
    </div>
      <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">Altura</label>
        <input type="text" class="form-control" name="altura" required   id="exampleFormControlInput1" placeholder="Informe a altura do produto">
      </div>
      <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">Largura</label>
        <input type="text" class="form-control" name="largura" required id="exampleFormControlInput1" placeholder="Informe a largura do produto">
      </div>
      <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">Peso(Kg)</label>
        <input type="text" class="form-control" name="peso" required id="exampleFormControlInput1" placeholder="Informe o peso do produto">
      </div>
      <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">Quantidade</label>
        <input type="text" class="form-control" name="quantidade" required id="exampleFormControlInput1" placeholder="Informe o peso do produto">
      </div>
     <div class="mb-3">
